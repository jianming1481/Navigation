...
void SimpleLayer::obstacle_detector_CB(const geometry_msgs::Twist::ConstPtr& msg) {
  int t = 3;
  tmp_x = msg->linear.x + msg->angular.x*t;
  tmp_y = msg->linear.y + msg->angular.y*t;
                                           ...
                                           double* min_y, double* max_x, double* max_y)
{
  ...
  // mark_x_ = tmp_dist*cos(tmp_angle+origin_yaw);
  // mark_y_ = tmp_dist*sin(tmp_angle+origin_yaw);
  mark_x_ = tmp_x;
  mark_y_ = tmp_y;
